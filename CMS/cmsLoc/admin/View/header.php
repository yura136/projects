...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href='/cmsLoc/admin/Assets/css/bootstrap.min.css' rel="stylesheet">

    <!-- Custom /admin/Assets/css/dashboard.css" rel="stylesheet">
    styles for this template -->
    <link href='/cmsLoc/admin/Assets/css/dashboard.css' rel="stylesheet">
